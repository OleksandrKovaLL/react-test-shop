...
import { clearCart, removeCartItem, plusCartItem, minusCartItem, minusDeleteCartItem, setLocalStorage } from '../redux/actions/cart';
...
function Cart() {
  ...
  const minusRemoveItem = (id) => {
    dispatch(minusDeleteCartItem(id, totalCount));
  };
